...
- Реализована на языке `Kotlin`
- Для визуального интерфейса использован фреймворк `TornadoFX`
- Используется хранение данных в реляционной СУБД `PostgreSQL`
- Хэширование паролей алгоритмом `SHA-512`
- Вместо потоков используются `корутины`

## Описание приложения
Клиент-серверное приложение, осуществляющее управление коллекцией объектов. <br>
Объекты хранятся в базе данных. <br>
Возможность при помощи визуального интерфейса добавлять, удалять, редактировать, искать по фильтрам объекты в коллекции. <br>
Добавлена авторизация. Доступ к изменению и удалению объекта есть только у создателя объекта. <br>
